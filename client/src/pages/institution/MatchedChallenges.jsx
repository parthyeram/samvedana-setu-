...
export default function MatchedChallenges() {
 ...
 const accept = id => acceptChallenge(id).then(() => navigate('/institution/projects')); const decline = id => declineChallenge(id).then(load); const info = id => requestChallengeInfo(id).then(load);
